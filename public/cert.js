...
function renderCert(c, opts){
  ...
  return ''
  + '<div class="sheet">'
  + '<div class="hdr"><div class="lg"><svg viewBox="0 0 100 72" xmlns="http://www.w3.org/2000/svg"><path d="M4 6h16l11 40 11-40h6l11 40 11-40h16L72 66H58L48 30 38 66H24L4 6z" fill="#000"/></svg><b>โรงพยาบาล<br>ดับเบิ้ลยู เมดิคอล</b></div>'
...
+ '.hdr .lg svg{width:56px;height:40px}'
+ '.hdr .lg b{display:block;font-size:8px;line-height:1.15}'
...
function renderCertFive(c, opts){
  ...
  + '<div class="fhdr"><div class="lg"><svg viewBox="0 0 100 72" xmlns="http://www.w3.org/2000/svg"><path d="M4 6h16l11 40 11-40h6l11 40 11-40h16L72 66H58L48 30 38 66H24L4 6z" fill="#000"/></svg></div>'
...
+ '.fhdr .lg{flex:0 0 54px}.fhdr .lg svg{width:52px;height:38px}'
